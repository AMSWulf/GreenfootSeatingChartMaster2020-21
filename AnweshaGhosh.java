 ...
 */
public class AnweshaGhosh extends Student implements StudentAthlete
{

    /**
     * Constructor for the AnweshaGhosh class.
     ...
     * 
     */
    public AnweshaGhosh(String f, String l, int r, int s) {
        firstName=f;
        lastName=l;
        mySeatX=r;
        mySeatY=s;
